defmodule Mix.Tasks.SelectoPostgrex.Validate.ParameterizedJoins do
  ...
  ## Examples
      ...
      mix selecto_postgrex.validate.parameterized_joins
      mix selecto_postgrex.validate.parameterized_joins --path lib/my_app/selecto_domains
      mix selecto_postgrex.validate.parameterized_joins lib/my_app/selecto_domains/user_domain.ex
      mix selecto_postgrex.validate.parameterized_joins --test-references "products:electronics:true.name,discounts:seasonal.amount"
  """

  use Mix.Task

  alias SelectoPostgrexMix.ParameterizedJoinsValidator
